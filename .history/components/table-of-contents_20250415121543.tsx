...
const TableOfContents = () => {
  ...
  // Organized sections with hierarchy
  const sections: Section[] = [
    ...
    {
      id: "dream-weaver-concept",
      title: "The Dream Weaver Concept",
      isMainSection: true,
    },
    {
      id: "ai-powered-evolution",
      title: "AI-Powered Evolution",
      isMainSection: true,
    },
    {
      id: "blockchain-significance",
      title: "Blockchain Significance",
      isMainSection: true,
    },
    {
      id: "emergence-as-feature",
      title: "Emergence as a Feature",
      isMainSection: true,
    },
    {
      id: "gameplay-loop",
      title: "Gameplay Loop Overview",
      isMainSection: true,
      subsections: [
        { id: "dream-realms", title: "Dream Realms & Nodes" },
        { id: "wisp-capturing", title: "Wisp Capturing & AR" },
        { id: "battle-system", title: "Battle System" },
        { id: "dream-rune", title: "Dream Rune System" },
      ],
    },
    { id: "player-progression", title: "Player Progression", isMainSection: true },
    { id: "social-creative", title: "Social & Creative Aspects", isMainSection: true },
  ]
