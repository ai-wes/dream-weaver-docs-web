...
export default async function MarkdownPage({ params }: PageProps) {
  ...
  const mdFilePath = path.join(process.cwd(), 'app', 'appendices', 'diagrams', 'page.md'); // <-- Updated path
  ...
  // NOTE: The markdown file contains Mermaid diagrams.
  // Rendering Mermaid diagrams usually requires a specific library or plugin
  // (like remark-mermaidjs or a client-side solution).
  // By default, react-markdown will render the code block but not the diagram.
...
//   return {
//     title: 'Appendices - Architecture Diagrams', // Placeholder title
//   };
// }