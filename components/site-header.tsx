  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-blue-900/40 bg-background/60 backdrop-blur-xl supports-[backdrop-filter]:bg-background/40">
      <div className="container flex h-16 items-center">
        <SidebarTrigger className="mr-2 text-blue-400 hover:text-blue-300" />
        <div className="mr-4 flex">
          <Link href="/" className="flex items-center space-x-2">
            ...
            <span className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-sky-400 glow-text">
              Dream Weaver
            </span>
          </Link>
        </div>
        <div className="flex flex-1 items-center justify-between space-x-2 md:justify-end">
          <nav className="flex items-center space-x-4">
            <Button variant="ghost" size="sm" asChild className="text-blue-200 hover:text-white hover:bg-blue-900/30">
              <Link href="/introduction/executive-summary">Documentation</Link>
            </Button>
            <Button variant="ghost" size="sm" asChild className="text-blue-200 hover:text-white hover:bg-blue-900/30">
              <Link href="/supporting-materials/whitepaper">Whitepaper</Link>
            </Button>
            <Button variant="ghost" size="sm" asChild className="text-blue-200 hover:text-white hover:bg-blue-900/30">
              <Link href="/contact-community/partnership-inquiries">Contact</Link>
            </Button>
          </nav>
