...
export default async function MarkdownPage({ params }: PageProps) {
  ...
  const mdFilePath = path.join(process.cwd(), 'app', 'dream-weaver-ai', 'nodes-ownership', 'page.md'); // <-- Updated path
  ...
  // NOTE: The markdown file contains HTML and <style> tags.
...
//   return {
//     title: 'DreamWeaver AI - Nodes & Ownership', // Placeholder title
//   };
// }