...
export default async function MarkdownPage({ params }: PageProps) {
  ...
  const mdFilePath = path.join(process.cwd(), 'app', 'architecture', 'ai-systems', 'page.md'); // <-- Updated path
  ...
  // NOTE: The markdown file contains a Mermaid diagram.
...
//   return {
//     title: 'Architecture - AI Systems', // Placeholder title
//   };
// }